...
abstract class _Error implements RoleState {
...
class _$CreateImpl implements _Create {
  const _$CreateImpl({required this.description, required this.name});
  ...
  TResult when<TResult extends Object?>({
    ...
    return create(description, name);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return create?.call(description, name);
  }
...
class _$EditImpl implements _Edit {
  ...
  TResult when<TResult extends Object?>({
    ...
    return edit(name, description, role);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return edit?.call(name, description, role);
  }
...
class _$DeleteImpl implements _Delete {
  const _$DeleteImpl({required this.role});
...
abstract class _Delete implements RoleEvent {
  const factory _Delete({required final Role role}) = _$DeleteImpl;
