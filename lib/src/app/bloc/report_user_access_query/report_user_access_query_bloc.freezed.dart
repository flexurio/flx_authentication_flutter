...
abstract class _Initial implements ReportUserAccessQueryState {
...
abstract class _Loading implements ReportUserAccessQueryState {
...
abstract class _Success implements ReportUserAccessQueryState {
  const factory _Success(final List<ReportAccess> roleEmployees) =
      _$SuccessImpl;
...
abstract class _Error implements ReportUserAccessQueryState {
...
class _$FetchImpl implements _Fetch {
  const _$FetchImpl({this.departmentName, this.employeeId});
  ...
  TResult when<TResult extends Object?>({
    ...
    return fetch(departmentName, employeeId);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return fetch?.call(departmentName, employeeId);
  }
